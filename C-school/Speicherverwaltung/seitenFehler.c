...
void optimal(int seiten, int laenge, int *feld)
{
    int i, j, k, flag = 0, count = 0, farthest, pos;
    int frame[seiten];
    for (i = 0; i < seiten; i++)
        frame[i] = -1;
